			...
			<div class="row">
				...
				<div class="col-sm-6">
					<div class="card shadow">
						<div class="card-body">
							<form:form action="${root }hotel_review_write_pro" method="post"
								modelAttribute="writeHotelContentBean"
								enctype="multipart/form-data">
								<form:hidden path="hotel_content_idx" />
								<div class="form-group">
									<form:label path="hotel_content_subject">제목</form:label>
									<form:input path="hotel_content_subject" class='form-control' />
									<form:errors path='hotel_content_subject' style='color:red' />
								</div>
								<div class="form-group">
									<form:label path="hotel_content_hotelname">호텔</form:label>
									<form:select path="hotel_content_hotelname" class='form-control'
										style="width: 450px;">
										<c:forEach var="obj" items="${reservationlist}">
										<form:option value="${obj.hotel_name }"></form:option>
										</c:forEach>
								...
								<div class="form-group">
									...
									<form:textarea path="hotel_content_text" class="form-control"
										rows="10" style="resize:none" />
									<form:errors path='hotel_content_text' style='color:red' />
								</div>
								<div class="form-group">
									<form:label path="hotel_content_writer_id">작성자</form:label>
									<form:input path="hotel_content_writer_id" class='form-control' value="${loginUserBean.user_id}"/>
									<form:errors path='hotel_content_writer_id' style='color:red' />
								</div>
								<div class="form-group">
									<form:label path="hotel_content_rating">평점(5점)</form:label>
									<form:input path="hotel_content_rating" class='form-control' />
