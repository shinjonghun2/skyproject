    ...
    <div class="container">
      ...
      <div class="row">        
            <div class="col-md-5 order-md-1">
             <img src="assets/images/sq_img_1.jpg" alt="객실 사진 입니다" width="300" style="float:right; margin-right: 20px;">
            </div>
             <!-- 왼쪽 -->
             <div class="col-md-7 order-md-1">
               <h4 class="mb-3">예약 정보</h4>
               <form:form action="${root }order_check_pro" class="needs-validation" modelAttribute="resBean"  >
                <div class="col-md-6 mb-3">
                        회원아이디<input type="text"  value="${loginUserBean.user_name}" class="form-control" name="user_id" style="width:350px;" readonly="readonly">
                   </div>
                    <div class="col-md-6 mb-3">
                   ...
                   <form:label path="reserve_phone">전화번호</form:label>
                    ...
                    <div class="custom-control custom-checkbox">
                      ...
                      <label class="custom-control-label" for="same-address">
                        ...
                        <br> 체크인 날짜는 ${check_in}, 체크아웃 날짜는 ${check_out}입니다.
                     </label>
                    </div>
