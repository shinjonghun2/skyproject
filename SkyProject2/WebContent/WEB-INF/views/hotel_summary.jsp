   ...
   <section class="probootstrap-cover overflow-hidden relative"
      ...
      <div class="container">
         <div class="row align-items-center text-center">
            <div class="col-md">
               <h2 class="heading mb-2 display-4 font-light probootstrap-animate">Hotel List</h2>
...
<!-- 호텔 1 -->
   <section class="probootstrap_section" id="section-city-guides">
      ...
      <div class="container">
       ...
       <c:forEach var="obj" items="${hotelList}">
         <div class="row mb-5">
            <div class="col-md-12">
           ...
           <div class="row">      
               ...
               <!--       <div style="font-size:22px; font-weight:bold; float:right;">가격</div>
               <br> -->
   ...
   <div class="widget mb-60">
        <div class="sidebar-form" style="position: absolute; bottom: 180px;" >
        호텔검색
